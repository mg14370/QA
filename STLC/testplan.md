...
### **Zielgruppe**
- **Privatpersonen ab 18 Jahren** (für vollen Zugriff auf 18+ Inhalte)  
...
- Altersverifikation:
  - Anzeige‑Pop‑up bei 18+ Produkten (z. B. alkoholische Produkte)
  - Tests müssen Anzeige/Access‑Kontrolle und API‑Antworten prüfen (UI + API)
...
- Ausführungsrate ≥ 95 %.  
- Bestehensrate ≥ 90 % der ausgeführten Testfälle.  
...
- **Daten:** Separate Testdatenbank / vorbereitete Testkonten  
- **Testdatensätze:** Vorbereitete Produktdatensätze (mind. 1 alkoholisches Produkt, mehrere bewertbare Produkte)
